...
<body>
		...
		<div class="container">
			...
			<div class="top_nav_right">
				<div class="cart box_1">
					...
					<p>
						<a href="javascript:;" class="simpleCart_empty">Item Cart</a>
					</p>
	...
	<div class="checkout">
		<div class="container">
			...
			%>
			<center>
				<strong>There is no item(s) in the Cart.&nbsp;<a href="index.jsp">Shop Now</a></strong>
			</center>
			<%
				}
			%>
			...
			<div class="checkout-left">
				<div class="checkout-right-basket animated wow slideInRight"
					...
					<a href="index.jsp"><span class="glyphicon glyphicon-menu-left"
						aria-hidden="true"></span>Back To Billing</a>
				</div>
			</div>
		</div>
	</div>
