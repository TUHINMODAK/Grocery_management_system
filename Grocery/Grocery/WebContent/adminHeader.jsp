			...
			<div class="col-md-12">
				<div class="navbar-collapse collapse ">
					<ul id="menu-top" class="nav navbar-nav navbar-right">
						...
						<li><a href="#" class="dropdown-toggle" id="ddlmenuItem"
							data-toggle="dropdown">Staff <i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu" role="menu"
								aria-labelledby="ddlmenuItem">
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="admin-view-customers.jsp">View Staffs</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1"
									href="admin-view-contacts.jsp">View Contacts</a></li>
									<li><a href="customer-register.jsp">Register Staff</a></li>
							</ul></li>
